...
@interface IndentFinishTableViewCell ()
{
    UILabel *_titleLabel;
...
@end
@implementation IndentFinishTableViewCell
...
- (void)drewContentViewWithIndexPathRRow:(NSInteger)index{
    _index = index;
    [self clearFrame];
    NSArray *titleArray = @[@"发布时间",@"姓名",@"电话",@"作业时间",@"作业地点",@"作业面积",@"农作物",@"服务类型",@"机手报价",@"接单时间",@"机手农机",@"完成时间"];
    NSArray *contentArray =@[@"2016-05-27",@"李四",@"188888888",@"2016-06-27",@"江苏且前后第八eqweqw王企鹅和千万个千万v我讲方法很烦的，加速度",@"200亩",@"水稻",@"旋耕",@"80元/亩",@"2016-06-27",@"拖拉机",@"2016-06-27"];
